...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0017_demandecomptebancaire_signature'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this employe belongs to. An employe will get all permissions granted to each of their groups.', related_name='custom_employe_groups', related_query_name='employe', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this employe.', related_name='custom_employe_permissions', related_query_name='employe', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
                'verbose_name': 'user',
